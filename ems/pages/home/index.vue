...
<script>
	...
	import operate from "../index/operate.vue"
	import table01 from "../table/table01.vue"
	export default {
		components: {
			uniNoticeBar,
			uniSegmentedControl,
		...
		data() {
			return {
				items: ['能耗', '产销', '排名'],
				current: 0,
				text:'通知：本系统正在开发中，欢迎大家及时在我的专栏反馈信息页面提供建议，如有疑问请联系管理员，QQ号1967609601，如有建议请及时反馈，感激不尽！！！'
			}
		},
		methods: {
			onClickItem(index) {
